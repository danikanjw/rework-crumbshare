...
export default function Home() {
  return (
    <main>
      ...
      {/* HERO */}
      <section
        className="relative z-10 min-h-screen justify-center items-center flex flex-col overflow-hidden bg-gradient-to-bl from-[#8d8d8d] via-[#d2d2d2] to-[#ffffff]"
        id="home"
      >
        {/* Row 1 */}
        <div className="flex flex-col items-center justify-center md:flex-row">
          ...
          <div className="order-2 flex w-full flex-col items-start max-w-4xl justify-center px-8 md:order-1 md:w-3/4 md:px-8">
            ...
            {/* Div Button */}
            {/* Div Button */}
            <div className="mt-3 flex gap-4 md:mt-8">
              <Link
                href="/register"
                className="rounded-full border bg-black px-6 py-3 text-center font-semibold text-white hover:border-black hover:bg-transparent hover:text-black md:w-43 md:text-lg"
              >
                Sign Up
              </Link>
              ...
              <Link
                href="/login"
                className="rounded-full border text-center border-black px-6 py-3 font-semibold text-black hover:bg-black hover:text-white md:w-43 md:text-lg"
              >
                Log In
              </Link>
            </div>
      ...
      {/* SECTION 2 */}
      <section
        className=" bg-white justify-center min-h-screen items-center flex"
        id="about"
      >
      ...
      {/* SECTION 4 */}
      <section
        className="flex min-h-screen items-center justify-center bg-white px-6 py-12 text-black"
        id="action"
      >
